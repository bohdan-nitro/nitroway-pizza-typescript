...
const FullPizza: React.FC = () =>  {
    ...
    const totalCountItems: number = totalCartItems ? totalCartItems.count : 0;

    const currentPrice = totalCountItems > 0 && <i>{totalCountItems}</i>;
        ...
        <div className="container">
            <div className="pizza-wrapper">
                ...
                <div className="right-side">
                    ...
                    <span>Добавить {currentPrice}</span>
                </Button>
                </div>
            </div>
        </div>
